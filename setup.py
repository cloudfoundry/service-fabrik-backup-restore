...
settings.update(
    ...
    long_description=
    'See README.md on https://github.com/cloudfoundry/service-fabrik-backup-restore',
    author=[],
    license='Apache 2.0',
    url='http://',
    keywords=
    "service fabrik service-fabrik backup restore backup-restore broker cloud foundry",
